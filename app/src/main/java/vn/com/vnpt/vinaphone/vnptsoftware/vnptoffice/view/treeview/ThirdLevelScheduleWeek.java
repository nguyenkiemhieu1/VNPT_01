...
public class ThirdLevelScheduleWeek extends MoveDocNodeViewBinder {
    TextView textView;
    ImageView imageView;
    ...
    public ThirdLevelScheduleWeek(View itemView, ArrayList<PersonAndUnitScheduleWeekInfo> listSelectPesonAndUnit, boolean hide) {
        super(itemView);
