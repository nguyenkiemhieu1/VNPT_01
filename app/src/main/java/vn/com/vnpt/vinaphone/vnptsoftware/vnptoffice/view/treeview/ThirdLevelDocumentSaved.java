...
public class ThirdLevelDocumentSaved extends MoveDocNodeViewBinder {
    TextView textView;
    ImageView imageView;
    ...
    public ThirdLevelDocumentSaved(View itemView) {
        super(itemView);
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    }

    public ThirdLevelDocumentSaved(View itemView, boolean hide) {
        super(itemView);
        hideButton = hide;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    ...
    public ThirdLevelDocumentSaved(View itemView, int type) {
        super(itemView);
        typeCheckBox = type;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
