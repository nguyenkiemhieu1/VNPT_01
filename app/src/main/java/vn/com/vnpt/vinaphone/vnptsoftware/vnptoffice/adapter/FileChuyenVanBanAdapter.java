...
import vn.com.vnpt.vinaphone.vnptsoftware.vnptoffice.view.activity.NewSendDocumentActivity;
...
public class FileChuyenVanBanAdapter extends ArrayAdapter<FileChiDao> {
    private Context context;
    private int resource;
    private List<FileChiDao> attachFileInfoList;
    private String type;

    public FileChuyenVanBanAdapter(Context context, int resource, List<FileChiDao> attachFileInfoList, String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ic_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (type.equals("SEND")) {
                    ((NewSendDocumentActivity) context).removeFile(attachFileInfo.getName());
