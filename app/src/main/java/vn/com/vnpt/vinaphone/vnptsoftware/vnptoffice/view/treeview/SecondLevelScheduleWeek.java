...
public class SecondLevelScheduleWeek extends MoveDocNodeViewBinder {
    TextView textView;
    ImageView imageView;
    ...
    public SecondLevelScheduleWeek(View itemView, ArrayList<PersonAndUnitScheduleWeekInfo> listSelectPesonAndUnit, boolean hide) {
        super(itemView);
