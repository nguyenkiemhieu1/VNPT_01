...
public class DialogPersonTaoCVClass extends Dialog {
    ...
    public DialogPersonTaoCVClass(@NonNull Context context) {
        super(context);

    }

    public DialogPersonTaoCVClass(@NonNull Context context, String strEndDate,
    ...
    public DialogPersonTaoCVClass(@NonNull Context context, String strEndDate,
                            List<PersonSendNotifyInfo> lstPersonByUnit, List<PersonSendNotifyInfo> lstUnit, List<ObjectAssignRequest> listSeleted) {
        super(context);
        activity = (Activity) context;
        this.strEndDate = strEndDate;
        this.lstPersonByUnit = lstPersonByUnit;
            ...
            if (treeView != null) {
                ...
                for (TreeNode treeNode : treeNodes) {
                    ...
                    for (int i = 0; i < listSeleted.size(); i++) {
                        if (personSendNotifyInfo.getName().equalsIgnoreCase(listSeleted.get(i).getNameUser())) {
    ...
    public void updatePersonList(List<PersonSendNotifyInfo> lstPersonByUnit, List<ObjectAssignRequest> listSeleted) {
        this.listSeleted = listSeleted;
        this.lstPersonByUnit.clear();
        this.lstPersonByUnit = lstPersonByUnit;
        viewGroup.removeAllViews();
        displayTreeView(this.lstPersonByUnit, 1, viewGroup);
    }
