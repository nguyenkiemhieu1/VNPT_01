...
public class FirstLevelOperatingNodeViewBinder extends CheckableOperatingNodeViewBinder {
    ...
    public FirstLevelOperatingNodeViewBinder(View itemView) {
        super(itemView);
    ...
    public int getLayoutId() {
        return R.layout.item_first_operating_level;
    }
