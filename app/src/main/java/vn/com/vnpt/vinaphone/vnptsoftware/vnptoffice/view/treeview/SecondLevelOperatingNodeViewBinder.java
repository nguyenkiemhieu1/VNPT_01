...
public class SecondLevelOperatingNodeViewBinder extends CheckableOperatingNodeViewBinder {
    ...
    public SecondLevelOperatingNodeViewBinder(View itemView) {
        super(itemView);
    ...
    public int getLayoutId() {
        return R.layout.item_second_operating_level;
    }
