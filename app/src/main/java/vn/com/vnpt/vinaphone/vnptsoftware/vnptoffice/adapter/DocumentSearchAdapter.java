...
public class DocumentSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<DocumentSearchInfo> datalist;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(final DocumentSearchInfo newItem) {
    ...
    public DocumentSearchAdapter(Context mContext, List<DocumentSearchInfo> datalist) {
    ...
    public int getItemViewType(int position) {
        if (datalist.get(position) instanceof DocumentSearchInfo) {
            return TYPE_NEW;
        } else {
            return TYPE_LOAD;
        }
