...
public class FirstLevelNodeViewTaoCVBinder extends MoveDocNodeViewTaoCVBinder {
    TextView textView;
    ImageView imageView;
    ...
    public FirstLevelNodeViewTaoCVBinder(View itemView) {
        super(itemView);
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    }

    public FirstLevelNodeViewTaoCVBinder(View itemView, boolean hide) {
        super(itemView);
        hideButton = hide;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    ...
    public FirstLevelNodeViewTaoCVBinder(View itemView, int type) {
        super(itemView);
        typeCheckBox = type;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    ...
    public int getLayoutId() {
        switch (typeCheckBox) {
            case 3:
                return R.layout.item_first_level_custom_image_tao_cv;
            default:
                return R.layout.item_first_level_custom_tao_cv;
        }
    }
