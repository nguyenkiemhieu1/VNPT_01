...
public class SubReplyChiDaoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//                    intent = new Intent(mContext, ReplyChiDaoActivity.class);
    ...
    public SubReplyChiDaoAdapter(Context mContext, List<ChiDaoFlow> datalist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_NEW) {
            return new MyViewHolder(inflater.inflate(R.layout.item_sub_reply, parent, false));
        } else {
