...
public class ThirdLevelNodeViewBinder extends MoveDocNodeViewBinder {
    ...
    public ThirdLevelNodeViewBinder(View itemView,boolean hide) {
        super(itemView);
        hideButton= hide;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    ...
    public ThirdLevelNodeViewBinder(View itemView, int type) {
        super(itemView);
        typeCheckBox = type;
        textView = (TextView) itemView.findViewById(R.id.node_name_view);
        imageView = (ImageView) itemView.findViewById(R.id.arrow_img);
    ...
    public int getLayoutId() {
        switch (typeCheckBox) {
            case 3:
                return R.layout.item_third_level_custom_image;
            default:
